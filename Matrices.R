...
plRandC <- GridM(RandC, Title = "C: Random")
plRandP <- GridM(RandP, Title = "P: Random")
...
plBandC <- GridM(BandC, Title = "C: Banded")
plConstP <- GridM(ConstP, Title = "P: Constant")
plCorrC <- GridM(CorrC, Title = "C: Correlated")
plRandP <- GridM(RandP, Title = "P: Random")
plTriC <- GridM(TriC, Title = "C: Lower Triangular")
plTriP <- GridM(TriP, Title = "P: Upper Triangular")
plNonSymC <- GridM(NonSymC, Title = "C: Non-Sym Tradeoff")
plSparseC <- GridM(SparseC, Title = "C: Sparse")
